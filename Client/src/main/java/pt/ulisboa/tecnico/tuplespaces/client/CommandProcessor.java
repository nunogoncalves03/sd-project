...
public class CommandProcessor {
    ...
    void parseInput() {
        ...
        this.clientService.shutdownChannel();
    }
    ...
    private void read(String[] split){
        ...
        // read the tuple
        System.out.println(this.clientService.read(tuple));
    }
    ...
    private void take(String[] split){
        ...
        // take the tuple
        System.out.println(this.clientService.take(tuple));
    }
    ...
    private void getTupleSpacesState(String[] split){
        ...
        System.out.println(this.clientService.getTupleSpacesState());
